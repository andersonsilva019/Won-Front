...
describe('<ExploreSidebar />', () => {
  ...
  it('should render inputs', () => {
    ...
    expect(
      screen.getByRole('checkbox', { name: /under \$150/i })
    ).toBeInTheDocument()

    expect(
      screen.getByRole('checkbox', { name: /under \$200/i })
    ).toBeInTheDocument()

    expect(screen.getByRole('checkbox', { name: /free/i })).toBeInTheDocument()

    expect(
      screen.getByRole('checkbox', { name: /discounted/i })
    ).toBeInTheDocument()
  ...
  it('should filter with cheked values', () => {
    const onFilter = jest.fn()
